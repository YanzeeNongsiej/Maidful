...
//   final String name;
//   const HireMaid({super.key, required this.name});
//   @override
...
//           children: [
//             Text(widget.name),
//             Text(GlobalVariables.instance.xmlHandler.getString('jobdetails'),
...
//                   ],
//                 ),
//                 // if (itemGlobal?.get("schedule") == 'Hourly')
//                 Visibility(
...
//                       ]),
//                 ),
//                 // if (itemGlobal?.get("schedule") == 'Daily' ||
//                 //     itemGlobal?.get("schedule") == 'Hourly')
//                 Visibility(
...
//                 //     for (var i = 0;
//                 //         i < itemGlobal?.get("work_history").length;
//                 //         i++)
//                 //       Padding(
//                 //         padding: const EdgeInsets.only(left: 30),
//                 //         child: Row(
...
//       uploadAck = {
//         "userid": user?.uid,
//         "receiver": itemGlobal?.get("userid"),
//         "schedule": "Live-in",
//         "days": daysList,
//         "time_from": "12:00 AM",
//         "time_to": "11:59 PM",
